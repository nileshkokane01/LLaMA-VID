...
class LlavaLlamaAttForCausalLM(LlamaForCausalLM, LLaMAVIDMetaForCausalLM):
    ...
    def forward(
        ...
        print('LlavaLlamaAttForCausalLM :  attention_mask '  )
        print('LlavaLlamaAttForCausalLM :  past_key_values '  )
        print('LlavaLlamaAttForCausalLM :  inputs_embeds '  )
        print('LlavaLlamaAttForCausalLM :  use_cache ' , use_cache)
        print('LlavaLlamaAttForCausalLM :  output_attentions ' )
