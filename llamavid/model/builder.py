...
def load_pretrained_model_dummy(model_path, model_base, model_name, load_8bit=False, load_4bit=False, device_map="auto", device="cuda"):
    ...
    if 'vid' in model_name.lower():
        ...
        model.get_model().initialize_attention_modules_dummy(model.config, for_eval=True)
