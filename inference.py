...
def main(args):
    ...
    model_name = get_model_name_from_path('work_dirs/llama-vid/llama-vid-7b-full-224-video-fps-1')
   
    print(model_name)
    tokenizer, model, image_processor, context_len = load_pretrained_model('work_dirs/llama-vid/llama-vid-7b-full-224-video-fps-1', args.model_base, model_name, args.load_8bit, args.load_4bit)
    ...
    args.image_file="eating_spaghetti.mp4"
